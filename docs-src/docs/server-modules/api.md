...
You can call this method from the client using the client-side __[API](/client-module/api/)__ module.
...
To issue a call to this api method on the client, we use the client-side __[API](/client-module/api/)__ module:
