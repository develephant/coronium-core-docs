...
!!! info "Other Commands"
    Any other commands will be returned as a keyed __table__ with various attributes. Manage your database creation and table structures using the internal administration tools. See __[Databases](/server/webmin/databases/)__ for more details.
...
See the Webmin __[databases](/server/webmin/databases/)__ section to learn how to administer your MySQL database.