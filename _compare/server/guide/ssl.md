...
2\. Copy and paste one of the following on the command line to run the Coronium Core SSL updater:
...
__Coronium Core 2.7.x or higher:__

```
wget https://s3.amazonaws.com/coronium-core/ssl2.sh && sudo bash ./ssl2.sh
```

__Coronium Core 2.6.x or lower:__
